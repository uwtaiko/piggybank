...
function refreshAll() {
    types_1.RefreshLogger.refreshAll();
}
...
function deleteMemberDialog() {
    createDialog('Delete Member', html_1.deleteMemberHTML(), 130, 300);
}
exports.deleteMemberDialog = deleteMemberDialog;
...
function handleDeleteMember(name) {
    handlers_1.menuDeleteMember(name);
}
...
exports.deleteMemberHTML = deleteMemberHTML;
